...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangeRecentPixel.put("ID", "AP2A.240805.005");
        propsToChangeRecentPixel.put("FINGERPRINT", "google/husky/husky:14/AP2A.240805.005/12025142:user/release-keys");
